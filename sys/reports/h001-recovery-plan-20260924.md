...
4. Nhánh nhập artifact đang thêm receipt kiểm hash và revision mới. Nếu đường này đạt kiểm thử, việc tạo job H001 kế tiếp vẫn cần bàn giao seed chính thức: ledger hiện giữ H001 cho H001f và chính sách brief chặn job thứ hai. Không tự release H001f hay tạo brief ngoài kho; cần một lựa chọn rõ của người dùng khi đường chuyển cụ thể đã kiểm chứng. Nếu không có đường nhập hợp lệ, giữ H001f ở cổng media. Không đổi mode hoặc gán quyết định giả.
